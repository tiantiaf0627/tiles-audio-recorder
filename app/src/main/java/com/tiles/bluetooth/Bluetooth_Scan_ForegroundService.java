...
public class Bluetooth_Scan_ForegroundService extends Service{
    ...
    private void scheduleNextService() {
        ...
        Intent bleScanIntent = new Intent(getApplicationContext(), Bluetooth_Scan_ForegroundService.class);
